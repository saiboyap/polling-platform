...
public class TrendingController {
    ...
    public ResponseEntity<ApiResponse<List<TrendingPollResponse>>> getTrending(
        ...
        List<TrendingPollResponse> result = trendingPollService != null
                ? trendingPollService.getTopPolls(limit)
                : List.of();
        return ResponseEntity.ok(ApiResponse.success(result, "Trending polls retrieved"));
    }
}
